const surahs = [
	...
	{ Order: 1, name: "محمد", verses: 38, type: "مدنية", summary: "الجهاد وأخلاق المسلمين." },
	{ Order: 1, name: "الفتح", verses: 29, type: "مدنية", summary: "صلح الحديبية." },
	{ Order: 1, name: "الحجرات", verses: 18, type: "مدنية", summary: "آداب المجتمع." },
	{ Order: 1, name: "ق", verses: 45, type: "مكية", summary: "البعث والحساب." },
	{ Order: 1, name: "الذاريات", verses: 60, type: "مكية", summary: "عاقبة المتقين." },
	{ Order: 1, name: "الطور", verses: 49, type: "مكية", summary: "دلائل التوحيد." },
	{ Order: 1, name: "النجم", verses: 62, type: "مكية", summary: "معجزة المعراج." },
	{ Order: 1, name: "القمر", verses: 55, type: "مكية", summary: "أحداث يوم القيامة." },
	{ Order: 1, name: "الرحمن", verses: 78, type: "مدنية", summary: "نعم الله المتكررة." },
	{ Order: 1, name: "الواقعة", verses: 96, type: "مكية", summary: "أهوال يوم القيامة." },
	{ Order: 1, name: "الحديد", verses: 29, type: "مدنية", summary: "الإنفاق في سبيل الله." },
	{ Order: 1, name: "المجادلة", verses: 22, type: "مدنية", summary: "أحكام اجتماعية." },
	{ Order: 1, name: "الحشر", verses: 24, type: "مدنية", summary: "تطهير المجتمع." },
	{ Order: 1, name: "الممتحنة", verses: 13, type: "مدنية", summary: "العلاقات مع غير المسلمين." },
	{ Order: 1, name: "الصف", verses: 14, type: "مدنية", summary: "الجهاد والوحدة." },
	{ Order: 1, name: "الجمعة", verses: 11, type: "مدنية", summary: "أهمية صلاة الجمعة." },
	{ Order: 1, name: "المنافقون", verses: 11, type: "مدنية", summary: "أخلاق المنافقين." },
	{ Order: 1, name: "التغابن", verses: 18, type: "مدنية", summary: "الإيمان بالله واليوم الآخر." },
	{ Order: 1, name: "الطلاق", verses: 12, type: "مدنية", summary: "أحكام الطلاق." },
	{ Order: 1, name: "التحريم", verses: 12, type: "مدنية", summary: "أخلاقيات الأسرة." },
	{ Order: 1, name: "الملك", verses: 30, type: "مكية", summary: "ملك الله وقدرته." },
	{ Order: 1, name: "القلم", verses: 52, type: "مكية", summary: "الأخلاق والآداب." },
	{ Order: 1, name: "الحاقة", verses: 52, type: "مكية", summary: "أهوال يوم القيامة." },
	{ Order: 1, name: "المعارج", verses: 44, type: "مكية", summary: "عاقبة المكذبين." },
	{ Order: 1, name: "نوح", verses: 28, type: "مكية", summary: "قصة النبي نوح ودعوته." },
	{ Order: 1, name: "الجن", verses: 28, type: "مكية", summary: "إيمان الجن بالقرآن." },
	{ Order: 1, name: "المزمل", verses: 20, type: "مكية", summary: "أوامر للنبي في العبادة." },
	{ Order: 1, name: "المدثر", verses: 56, type: "مكية", summary: "الدعوة والإعداد لها." },
	{ Order: 1, name: "القيامة", verses: 40, type: "مكية", summary: "البعث والحساب." },
	{ Order: 1, name: "الإنسان", verses: 31, type: "مدنية", summary: "جزاء المتقين." },
	{ Order: 1, name: "المرسلات", verses: 50, type: "مكية", summary: "إنذار يوم القيامة." },
	{ Order: 1, name: "النبأ", verses: 40, type: "مكية", summary: "أهوال يوم القيامة." },
	{ Order: 1, name: "النازعات", verses: 46, type: "مكية", summary: "دلائل البعث." },
	{ Order: 1, name: "عبس", verses: 42, type: "مكية", summary: "إهمال النبي للأعمى." },
	{ Order: 1, name: "التكوير", verses: 29, type: "مكية", summary: "أهوال القيامة." },
	{ Order: 1, name: "الإنفطار", verses: 19, type: "مكية", summary: "دلائل يوم الحساب." },
	{ Order: 1, name: "المطففين", verses: 36, type: "مكية", summary: "التحذير من الغش." },
	{ Order: 1, name: "الإنشقاق", verses: 25, type: "مكية", summary: "دلائل الآخرة." },
	{ Order: 1, name: "البروج", verses: 22, type: "مكية", summary: "التحذير من عاقبة الظلم." },
	{ Order: 1, name: "الطارق", verses: 17, type: "مكية", summary: "دلائل قدرة الله." },
	{ Order: 1, name: "الأعلى", verses: 19, type: "مكية", summary: "الحث على التذكر والتسبيح." },
	{ Order: 1, name: "الغاشية", verses: 26, type: "مكية", summary: "الحساب." },
	{ Order: 1, name: "الفجر", verses: 30, type: "مكية", summary: "عاقبة الطغاة." },
	{ Order: 1, name: "البلد", verses: 20, type: "مكية", summary: "التحديات في الحياة." },
	{ Order: 1, name: "الشمس", verses: 15, type: "مكية", summary: "أهمية تزكية النفس." },
	{ Order: 1, name: "الليل", verses: 21, type: "مكية", summary: "العمل في الدنيا." },
	{ Order: 1, name: "الضحى", verses: 11, type: "مكية", summary: "فضل الله على النبي." },
	{ Order: 1, name: "الشرح", verses: 8, type: "مكية", summary: "تخفيف العبء عن النبي." },
	{ Order: 1, name: "التين", verses: 8, type: "مكية", summary: "خلق الإنسان في أحسن تقويم." },
	{ Order: 1, name: "العلق", verses: 19, type: "مكية", summary: "بداية الوحي." },
	{ Order: 1, name: "القدر", verses: 5, type: "مكية", summary: "ليلة القدر." },
	{ Order: 1, name: "البينة", verses: 8, type: "مدنية", summary: "الفرق بين الحق والباطل." },
	{ Order: 1, name: "الزلزلة", verses: 8, type: "مدنية", summary: "أحداث يوم القيامة." },
	{ Order: 1, name: "العاديات", verses: 11, type: "مكية", summary: "صفة الخيل في الجهاد." },
	{ Order: 1, name: "القارعة", verses: 11, type: "مكية", summary: "أهوال يوم القيامة." },
	{ Order: 1, name: "التكاثر", verses: 8, type: "مكية", summary: "التحذير من حب المال." },
	{ Order: 1, name: "العصر", verses: 3, type: "مكية", summary: "أهمية الوقت." },
	{ Order: 1, name: "الهمزة", verses: 9, type: "مكية", summary: "عاقبة السخرية." },
	{ Order: 1, name: "الفيل", verses: 5, type: "مكية", summary: "حادثة الفيل." },
	{ Order: 1, name: "قريش", verses: 4, type: "مكية", summary: "فضل قريش." },
	{ Order: 1, name: "الماعون", verses: 7, type: "مكية", summary: "أفعال المنافقين." },
	{ Order: 1, name: "الكوثر", verses: 3, type: "مكية", summary: "نعمة الكوثر." },
	{ Order: 1, name: "الكافرون", verses: 6, type: "مكية", summary: "البراءة من الشرك." },
	{ Order: 1, name: "النصر", verses: 3, type: "مدنية", summary: "وعد النصر." },
	{ Order: 1, name: "المسد", verses: 5, type: "مكية", summary: "مصير أبي لهب." },
	{ Order: 1, name: "الإخلاص", verses: 4, type: "مكية", summary: "توحيد الله." },
