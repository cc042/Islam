...
const elements = {
    ...
    alert1: document.querySelector("dialog.alert1"),
...
const projects = [
    ...
    { NAME: "Weight", LINK: "https://ngs-weight.vercel.app/", DESCRIPTION: "ادخل وزنك على اى كوكب من كواكب المجموعة الشمسية" },
];
...
class Zekr {
    constructor(elements) {
        ...
        this.counter1 = 0;
        this.counter2 = parseInt(localStorage.getItem("counter"), 10) || 0;
...
if (elements.scrollup) {
    ...
    const checkScrollPosition = () => {
        if (window.scrollY > 300 && !isScrolling) {
            ...
            setTimeout(() => elements.scrollup.style.opacity = '1', 10);
    ...
    const scrollToTop = () => {
        isScrolling = true;
        elements.scrollup.style.opacity = '1';
        elements.scrollup.style.display = 'flex';
...
window.addEventListener("resize", () => {
    if (elements.SurahsWrapper) {
        sideBar.gridResposive(elements.SurahsWrapper);
    }
});
