...
document.onkeydown = function (e) {
    ...
    if (e.ctrlKey && e.key == "C".charCodeAt(0)) return false;
    if (e.ctrlKey && e.key == "X".charCodeAt(0)) return false;
...
setInterval(() => { timeshow.innerHTML = new Intl.DateTimeFormat('ar-Fr-u-ca-islamic', { day: 'numeric', month: 'long', weekday: 'long', year: 'numeric', hour: 'numeric', minute: 'numeric', second: 'numeric' }).format(Date.now()) }, 1000);
